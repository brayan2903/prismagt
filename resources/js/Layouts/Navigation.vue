    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
         ...
         <div class="flex justify-center items-center mt-8">
            <div class="flex items-center">
                <img :src="'/images/fondo_agua.png'" alt="ERP PRISMA" class="w-12 h-12">
                <span class="mx-2 text-2xl font-semibold text-white">ERP PRISMA</span>
            </div>
        </div>
        ...
        <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
            ...
            <nav-link :href="route('clientes')" :active="route().current('clientes')">
                <template #icon>
                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
            ...
            <nav-link :href="route('clientes.osxperiodo')" :active="route().current('clientes.osxperiodo')">
                <template #icon>
                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
            ...
            <nav-link :href="route('reportes')" :active="route().current('reportes')">
                <template #icon>
                    <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
